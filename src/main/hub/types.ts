...
export type ResourceDetail = {
  // download_url: string
  avatar_date: StringifiedShortDate
  category: Category
  current_version_id: StringifiedNumber
  dependency_count: number
  discussion_thread_id: StringifiedNumber
  download_count: StringifiedNumber
  external_url: string
  hub_hosted: '0' | '1'
  hubDownloadable: StringifiedBool
  hubFiles: unknown[]
  hubHosted: StringifiedBool
  icon_url: string
  image_url: string
  last_update: StringifiedShortDate
  package_id: StringifiedNumber
  parent_category_id: StringifiedNumber
  popularity: StringifiedDecimal | null
  promotional_link: string
  rating_avg: StringifiedNumber
  rating_count: StringifiedNumber
  rating_weighted: StringifiedDecimal
  reaction_score: StringifiedNumber
  release_date: StringifiedShortDate
  resource_date: StringifiedShortDate
  resource_id: StringifiedNumber
  review_count: StringifiedNumber
  tag_line: string
  tags: StringifiedArray
  thtrending_downloads_per_minute: StringifiedDecimal
  thtrending_positive_rating_count: StringifiedNumber
  thtrending_positive_ratings_per_minute: StringifiedDecimal
  title: string
  type: string
  update_count: StringifiedNumber
  user_id: StringifiedNumber
  username: string
  version_string: StringifiedNumber
  view_count: StringifiedNumber
}
