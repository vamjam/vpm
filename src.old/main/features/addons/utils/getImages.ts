...
import ExtensionMap from '~/features/package/maps/ExtensionMap'
import { Manifest } from '~/features/vam'
...
const mapToImage = (path: string, sort: number) => ({
  path,
  sort,
})
 ...
 * 1. via the "contentList" array for paths to image files,
